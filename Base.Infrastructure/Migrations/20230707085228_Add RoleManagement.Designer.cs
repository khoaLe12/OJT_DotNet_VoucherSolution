...
namespace Base.Infrastructure.Migrations
{
    ...
    [Migration("20230707085228_Add RoleManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Base.Core.Identity.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Base.Core.Identity.RoleManagement", b =>
                {
                    b.Property<int>("ManagedRoleId")
                        .HasColumnType("int");

                    b.Property<int>("ManagerRoleId")
                        .HasColumnType("int");

                    b.HasKey("ManagedRoleId", "ManagerRoleId");
            ...
            modelBuilder.Entity("Base.Core.Identity.UserManagement", b =>
                {
            ...
            modelBuilder.Entity("Base.Core.Identity.RoleManagement", b =>
                {
                    b.HasOne("Base.Core.Entity.Role", "ManagedRole")
                        .WithMany("ManagerRoles")
                        .HasForeignKey("ManagedRoleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Base.Core.Entity.Role", "ManagerRole")
                        .WithMany("ManagedRoles")
                        .HasForeignKey("ManagerRoleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("ManagedRole");
            ...
            modelBuilder.Entity("Base.Core.Identity.UserManagement", b =>
                {
                    b.HasOne("Base.Core.Entity.User", "Manager")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("RolePermissions", b =>
                {
                    b.HasOne("Base.Core.Identity.Permission", null)
                        .WithMany()
